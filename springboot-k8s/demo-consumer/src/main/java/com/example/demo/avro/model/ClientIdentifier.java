...
public class ClientIdentifier extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1740134931308808980L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ClientIdentifier\",\"namespace\":\"com.example.demo.avro.model\",\"fields\":[{\"name\":\"hostName\",\"type\":\"string\"},{\"name\":\"ipAddress\",\"type\":\"string\"}]}");
   ...
   */
  public static com.example.demo.avro.model.ClientIdentifier.Builder newBuilder() {
    return new com.example.demo.avro.model.ClientIdentifier.Builder();
  }
   ...
   * @return A new ClientIdentifier RecordBuilder
   */
  public static com.example.demo.avro.model.ClientIdentifier.Builder newBuilder(com.example.demo.avro.model.ClientIdentifier.Builder other) {
    if (other == null) {
      return new com.example.demo.avro.model.ClientIdentifier.Builder();
    } else {
      return new com.example.demo.avro.model.ClientIdentifier.Builder(other);
    }
  }
   ...
   * @return A new ClientIdentifier RecordBuilder
   */
  public static com.example.demo.avro.model.ClientIdentifier.Builder newBuilder(com.example.demo.avro.model.ClientIdentifier other) {
    if (other == null) {
      return new com.example.demo.avro.model.ClientIdentifier.Builder();
    } else {
      return new com.example.demo.avro.model.ClientIdentifier.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ClientIdentifier>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.demo.avro.model.ClientIdentifier.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.demo.avro.model.ClientIdentifier other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.hostName)) {
        this.hostName = data().deepCopy(fields()[0].schema(), other.hostName);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.avro.model.ClientIdentifier.Builder setHostName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.avro.model.ClientIdentifier.Builder clearHostName() {
      hostName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.avro.model.ClientIdentifier.Builder setIpAddress(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.avro.model.ClientIdentifier.Builder clearIpAddress() {
      ipAddress = null;
