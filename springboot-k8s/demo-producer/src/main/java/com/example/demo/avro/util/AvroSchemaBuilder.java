package com.example.demo.avro.util;
...
public class AvroSchemaBuilder {
    public Schema createAvroHttpRequestSchema(){
        ...
        Schema clientIdentifier = SchemaBuilder.record("ClientIdentifier").namespace("com.example.avro.model")
                .fields().requiredString("hostName").requiredString("ipAddress").endRecord();

        Schema avroHttpRequest = SchemaBuilder.record("AvroHttpRequest").namespace("com.example.avro.model").fields()
