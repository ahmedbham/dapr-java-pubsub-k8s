 ...
 */
package com.example.demo.avro.model;
...
public class AvroHttpRequest extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static AvroHttpRequest fromByteBuffer(
   ...
   private com.example.demo.avro.model.ClientIdentifier clientIdentifier;
   private java.util.List<java.lang.CharSequence> employeeNames;
   private com.example.demo.avro.model.Active active;
   ...
   */
  public AvroHttpRequest(java.lang.Long requestTime, com.example.demo.avro.model.ClientIdentifier clientIdentifier, java.util.List<java.lang.CharSequence> employeeNames, com.example.demo.avro.model.Active active) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: clientIdentifier = (com.example.demo.avro.model.ClientIdentifier)value$; break;
    case 2: employeeNames = (java.util.List<java.lang.CharSequence>)value$; break;
    case 3: active = (com.example.demo.avro.model.Active)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public com.example.demo.avro.model.ClientIdentifier getClientIdentifier() {
   ...
   * @param value the value to set.
   */
  public void setClientIdentifier(com.example.demo.avro.model.ClientIdentifier value) {
   ...
   */
  public com.example.demo.avro.model.Active getActive() {
    return active;
  }
   ...
   * @param value the value to set.
   */
  public void setActive(com.example.demo.avro.model.Active value) {
    this.active = value;
  }
   ...
   */
  public static com.example.demo.avro.model.AvroHttpRequest.Builder newBuilder() {
    return new com.example.demo.avro.model.AvroHttpRequest.Builder();
  }
   ...
   * @return A new AvroHttpRequest RecordBuilder
   */
  public static com.example.demo.avro.model.AvroHttpRequest.Builder newBuilder(com.example.demo.avro.model.AvroHttpRequest.Builder other) {
    if (other == null) {
      return new com.example.demo.avro.model.AvroHttpRequest.Builder();
    } else {
      return new com.example.demo.avro.model.AvroHttpRequest.Builder(other);
    }
  }
   ...
   * @return A new AvroHttpRequest RecordBuilder
   */
  public static com.example.demo.avro.model.AvroHttpRequest.Builder newBuilder(com.example.demo.avro.model.AvroHttpRequest other) {
    if (other == null) {
      return new com.example.demo.avro.model.AvroHttpRequest.Builder();
    } else {
      return new com.example.demo.avro.model.AvroHttpRequest.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroHttpRequest>
    ...
    private long requestTime;
    private com.example.demo.avro.model.ClientIdentifier clientIdentifier;
    private com.example.demo.avro.model.ClientIdentifier.Builder clientIdentifierBuilder;
    private java.util.List<java.lang.CharSequence> employeeNames;
    private com.example.demo.avro.model.Active active;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.demo.avro.model.AvroHttpRequest.Builder other) {
      super(other);
      ...
      if (other.hasClientIdentifierBuilder()) {
        this.clientIdentifierBuilder = com.example.demo.avro.model.ClientIdentifier.newBuilder(other.getClientIdentifierBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.demo.avro.model.AvroHttpRequest other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.requestTime)) {
        this.requestTime = data().deepCopy(fields()[0].schema(), other.requestTime);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.avro.model.AvroHttpRequest.Builder setRequestTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.avro.model.AvroHttpRequest.Builder clearRequestTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.avro.model.AvroHttpRequest.Builder setClientIdentifier(com.example.demo.avro.model.ClientIdentifier value) {
     ...
     * @return This builder.
     */
    public com.example.demo.avro.model.ClientIdentifier.Builder getClientIdentifierBuilder() {
      if (clientIdentifierBuilder == null) {
        if (hasClientIdentifier()) {
          setClientIdentifierBuilder(com.example.demo.avro.model.ClientIdentifier.newBuilder(clientIdentifier));
        } else {
          setClientIdentifierBuilder(com.example.demo.avro.model.ClientIdentifier.newBuilder());
        }
      }
    ...
    public com.example.demo.avro.model.AvroHttpRequest.Builder setClientIdentifierBuilder(com.example.demo.avro.model.ClientIdentifier.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.avro.model.AvroHttpRequest.Builder clearClientIdentifier() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.avro.model.AvroHttpRequest.Builder setEmployeeNames(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.avro.model.AvroHttpRequest.Builder clearEmployeeNames() {
      employeeNames = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.avro.model.AvroHttpRequest.Builder setActive(com.example.demo.avro.model.Active value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.avro.model.AvroHttpRequest.Builder clearActive() {
      active = null;
    ...
    public AvroHttpRequest build() {
      try {
        ...
        if (clientIdentifierBuilder != null) {
          ...
          record.clientIdentifier = fieldSetFlags()[1] ? this.clientIdentifier : (com.example.demo.avro.model.ClientIdentifier) defaultValue(fields()[1]);
        }
        record.employeeNames = fieldSetFlags()[2] ? this.employeeNames : (java.util.List<java.lang.CharSequence>) defaultValue(fields()[2]);
        record.active = fieldSetFlags()[3] ? this.active : (com.example.demo.avro.model.Active) defaultValue(fields()[3]);
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (this.clientIdentifier == null) {
        this.clientIdentifier = new com.example.demo.avro.model.ClientIdentifier();
      }
      ...
      this.active = com.example.demo.avro.model.Active.values()[in.readEnum()];
